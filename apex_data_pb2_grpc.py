...
class SampleDataStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Send = channel.unary_stream(
        ...
        response_deserializer=apex__data__pb2.SampleSingleDataResponse.FromString,
        )
...
def add_SampleDataServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Send': grpc.unary_stream_rpc_method_handler(
          ...
          response_serializer=apex__data__pb2.SampleSingleDataResponse.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
