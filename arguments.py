...
def argparser():
    ...
    parser.add_argument('--threshold_size', type=int, default=5000,
    ...
    parser.add_argument('--tensorboard_update_interval', type=int, default=200,
                        help='Interval of updating tensorboard')
